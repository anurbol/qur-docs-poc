...
const codeBlock = QurDocs.insertions // codeBlock, linkToArticle
...
const pages = QurDocs.pages({
    ...
    ${
        codeBlock(() => {
            const linkToArticle = (title: keyof typeof pages) => {
              
            }

            linkToArticle("some page") // deep-nested stuff is hard to access with keyof
