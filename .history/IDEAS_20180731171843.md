...
how can they use?
All traffic MUST go through SSH
What else for security? 
(security MUST be considered VERY strongly because one fault can 
drop reputation for years (but maybe bad PR is also PR so)https://security.stackexchange.com/questions/53596/how-safe-is-ssl
)