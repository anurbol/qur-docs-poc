...
const state = {
    ...
    !!!
    ! if you are curious why above code is so weird and verbose, please 
    ! read about ${action} and ${side_effect}
    !!!
    ^^^ THERE MUST BE some syntax to make these fast notes how()
}
